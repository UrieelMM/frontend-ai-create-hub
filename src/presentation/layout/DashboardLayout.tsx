  ...
  return (
    <main className="flex flex-row mt-7">
      <nav className="hidden sm:flex flex-col ml-5 w-[370px] min-h-[calc(100vh-3.0rem)] bg-white bg-opacity-10 p-5 rounded-3xl">
        <h1 className="font-bold text-lg lg:text-2xl bg-gradient-to-br from-cyan-300 via-cyan/50 bg-clip-text text-transparent">
          Asistente de estudio<span className="text-cyan-500">.</span>
        </h1>
